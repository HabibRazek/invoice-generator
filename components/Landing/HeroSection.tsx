...
const HeroSection = () => {
  return (
    <div className="relative bg-light-theme dark:bg-dark-theme overflow-hidden h-[600px]">
        ...
        <div className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
          <div className="max-w-3xl text-center mx-auto">
            <p className="inline-block text-sm font-medium bg-clip-text bg-gradient-to-l from-[#22577A] to-[#38A3A5] text-transparent dark:from-[#57CC99] dark:to-[#80ED99]">
              Your Ultimate Invoice Management Solution
            </p>

            <div className="mt-5 max-w-3xl">
              <h1 className="block font-semibold text-[#22577A] text-4xl md:text-5xl lg:text-6xl dark:text-[#C7F9CC]">
                Streamline Your Invoicing with Custom Solutions
              </h1>
            </div>

            <div className="mt-5 max-w-4xl">
              <p className="text-lg text-[#38A3A5] dark:text-[#80ED99]">
                Manage your invoices effortlessly and generate custom invoices tailored to your needs. Our system provides an intuitive interface to streamline your invoicing process and ensure accurate billing every time.
              </p>
            </div>
